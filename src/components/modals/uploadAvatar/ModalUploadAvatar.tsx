...
export const ModalUploadAvatar: FC = () => {
    ...
    const accessToken = useSelector((state: RootState) => state.userReducer.access_token)
    const refreshToken = useSelector((state:RootState)=>state.userReducer.refresh_token)
